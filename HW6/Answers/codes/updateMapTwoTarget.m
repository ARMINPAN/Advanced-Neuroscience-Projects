function updateMapTwoTarget(cat_loc, target_loc, mouse_loc, cat, mouse, cheese, target2_loc)
    xlim([0 15]); ylim([0 15])
    ...
    hold on;
    image(flipud(cheese), 'XData', [target2_loc(2) target2_loc(2)+1],...
        'YData', [target2_loc(1) target2_loc(1)+1]);
