...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function surrTensor = CFR(inputTensor,model_dim,numSurrogates)
    startup
    ...
    [R2_data] = summarizeLDS(dataTensor(:, :, :), model_dim, false); % function that evaluates the summary statistic of the LDS structure
    ...
    for i = 1:numSurrogates
        ...
        [R2_surr(i)] = summarizeLDS(surrTensor(:, :, :), model_dim, false);
    end
    % evaluate a P value
